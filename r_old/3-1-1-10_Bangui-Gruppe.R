...
ggsave("../output/figs/3-1-1-10_Bangui_Verbreitung.pdf", width = 11, height = 11)
...
# Karte
pdf("../output/figs/3-1-1-10_Bangui_Verbreitung_B.pdf", width = 5.5, height = 7)
plotRGB(r)
plot(gb.regenwald, add = TRUE, col = 'gray50', lwd = 2, lty = 3)
plot(gb.rivers, add = TRUE, col = 'gray40', lwd = 1)
# QGIS:  '#c0dfff'
plot(gb.lakes, add = TRUE, col = 'gray40', border = 'gray40')
plot(gb.countries, add = TRUE, col = 'gray50', lwd = 1, lty = 2)
plot(locs2, add = TRUE, pch = 21, bg = 'gray90', col = 'gray50', cex = 1.5)
text(x = locs2$x_long, y = locs2$y_lat, labels=locs2$`Kat-Nr`, pos=4, cex=0.8)
plot(locs1, add = TRUE, pch = 21, col = 'white', cex = 1.5)
