...
ggsave("../output/figs/3-1-1-2_Ngbanja_Verbreitung.pdf", width = 11, height = 11)
...
# Karte
pdf("../output/figs/3-1-1-2_Ngbanja_Verbreitung_B.pdf", width = 8, height = 8)
plotRGB(r)
