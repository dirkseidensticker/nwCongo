...
# df_a <- data.frame(tapply(df$Gewicht, list(df$Gr_Clist), sum, na.rm=TRUE))
...
pdf("../output/figs/9-13_MUN87-211_Fragmentierung_2.pdf", width = 10, height = 2.5)
