...
ggsave("../output/figs/3-1-2-2_Ngombe_Verbreitung.pdf", width = 11, height = 11)
```
...
ggsave("../output/figs/3-1-2-2_Ngombe_Verbreitung_B.pdf", width = 11, height = 11)
...
# Karte
pdf("../output/figs/3-1-2-2_Ngombe_Verbreitung_C.pdf", width = 8, height = 8)
plotRGB(r)
